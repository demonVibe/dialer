...
export class VoicecallService {
  ...
  sendVoiceCall(logData: Logs): Promise<HTTPResponse> {
    const caller_id = this.common.callerId || environment.callerId;
    ...
    let body = {
      ...
      voice_file: environment.voiceFile || 'http://caller.clickiexpress.com/frontend/web/media/recording/14221/2021072722293314221359936167.mp3',
